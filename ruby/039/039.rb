right_triangles = (1..1000).map { |a| (1..1000).map { |b| { a: a, b: b, c: Math.sqrt((a ** 2) + (b ** 2)) } } }.flatten(1)
...
puts grouped_by_perimeter.max_by { |perimeter, triangles| triangles.length }.first
